...
Fifth, we test only the mutual $\kappa$-nearest-neighbour measure of kernel alignment. Other methods, such as CKA, SVCCA, and CKNNA, may produce different results.
