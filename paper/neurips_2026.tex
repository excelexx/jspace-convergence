...
We instead hold the metric fixed and vary only the \emph{subspace} it is computed in. 

Platonic convergence is also contested. \citet{koepke2026platoscaveexaminingcrossmodal} find that alignment is more about coarse semantic overlap, and \citet{bangachev2026representationalignmentrestslinear} partly attribute alignment to word frequency. These findings suggest that representational alignment measures are not entirely semantic, a question we directly answer.
